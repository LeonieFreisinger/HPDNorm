...
## FNN_sw
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 0.0 --gen_func "gen_model_and_params_none"  > soutfile0 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 1.0 --gen_func "gen_model_and_params_none" > soutfile1 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 2.0 --gen_func "gen_model_and_params_none" > soutfile2 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 3.0 --gen_func "gen_model_and_params_none"  > soutfile3 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 4.0 --gen_func "gen_model_and_params_none"  > soutfile4 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 5.0 --gen_func "gen_model_and_params_none"  > soutfile5 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 6.0 --gen_func "gen_model_and_params_none"  > soutfile6 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 7.0 --gen_func "gen_model_and_params_none"  > soutfile7 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 8.0 --gen_func "gen_model_and_params_none"  > soutfile8 &
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_none"  > soutfile9 &
