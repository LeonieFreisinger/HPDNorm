...
# nohup python EXP_SYN_DATA.py --model TorchProphetModel --params TP --heterogeneity_type "heteroscedasticity" --sample_upper_limit 4.0 --gen_func "gen_model_and_params_scalers" > houtfile2 &
nohup python EXP_SYN_DATA.py --model TorchProphetModel --params TP_localST --heterogeneity_type "heteroscedasticity" --sample_upper_limit 6.0 --gen_func "gen_model_and_params_scalers"  > houtfile3 &
# nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN --heterogeneity_type "heteroscedasticity" --sample_upper_limit 5.0 --gen_func "gen_model_and_params_scalers_reweighting"  > houtfile4 &
# nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "heteroscedasticity" --sample_upper_limit 1.0 --gen_func "gen_model_and_params_scalers_reweighting"  > houtfile5 &
# nohup python EXP_SYN_DATA.py --model RNNModel --params RNN --heterogeneity_type "heteroscedasticity" --sample_upper_limit 6.0 --gen_func "gen_model_and_params_scalers"  > houtfile6 &
