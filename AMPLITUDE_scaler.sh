...
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP --heterogeneity_type "amplitude" --sample_upper_limit 1.0 --gen_func "gen_model_and_params_scalers_reweighting"  > aoutfile0 &
...
nohup python EXP_SYN_DATA.py --model TorchProphetModel --params TP --heterogeneity_type "amplitude" --sample_upper_limit 5.0 --gen_func "gen_model_and_params_scalers" > aoutfile2 &
nohup python EXP_SYN_DATA.py --model SeasonalNaiveModel --params TP_localST --heterogeneity_type "amplitude" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers"  > aoutfile3 &
...
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "amplitude" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers_reweighting"  > aoutfile5 &
