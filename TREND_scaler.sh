...
nohup python EXP_SYN_DATA.py --model SeasonalNaiveModel --params TP_localST --heterogeneity_type "trend" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers"  > toutfile3 &
...
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "trend" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers_reweighting"  > toutfilet5 &
nohup python EXP_SYN_DATA.py --model RNNModel --params RNN --heterogeneity_type "trend" --sample_upper_limit 1.0 --gen_func "gen_model_and_params_scalers"  > toutfile6 &
nohup python EXP_SYN_DATA.py --model TransformerModel --params TF --heterogeneity_type "trend" --sample_upper_limit 2.0 --gen_func "gen_model_and_params_scalers"  > toutfile7 &
nohup python EXP_SYN_DATA.py --model LightGBMModel --params LGBM --heterogeneity_type "trend" --sample_upper_limit 4.0 --gen_func "gen_model_and_params_scalers"  > toutfile8 &
