...
nohup python EXP_SYN_DATA.py --model SeasonalNaiveModel --params TP_localST --heterogeneity_type "offset" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers"  > ooutfile3 &
...
nohup python EXP_SYN_DATA.py --model NeuralProphetModel --params NP_FNN_sw --heterogeneity_type "offset" --sample_upper_limit 9.0 --gen_func "gen_model_and_params_scalers_reweighting"  > ooutfile5 &
