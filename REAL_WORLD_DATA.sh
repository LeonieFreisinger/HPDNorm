...
nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP --gen_func "gen_model_and_params_scalers_reweighting" > npoutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP_localST --gen_func "gen_model_and_params_scalers_reweighting" > nploutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP_FNN --gen_func "gen_model_and_params_scalers_reweighting" > npfoutfile5 &

### NP_FNN_sw
nohup python EXP_REAL_DATA.py --dataset EIA --model NeuralProphetModel --params NP_FNN_sw --gen_func "gen_model_and_params_scalers_reweighting" > npfsoutfile0 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP_FNN_sw --gen_func "gen_model_and_params_scalers_reweighting" > npfsoutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model TorchProphetModel --params TP --gen_func "gen_model_and_params_scalers" > tpoutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model TorchProphetModel --params TP_localST --gen_func "gen_model_and_params_scalers" > tploutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model TransformerModel --params TF --gen_func "gen_model_and_params_scalers" > tfoutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model RNNModel --params RNN --gen_func "gen_model_and_params_scalers" > routfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model NaiveModel --params Naive --gen_func "gen_model_and_params_scalers" > noutfile5 &
...
nohup python EXP_REAL_DATA.py --dataset ETTh --model SeasonalNaiveModel --params SNaive --gen_func "gen_model_and_params_scalers" > snoutfile5 &
...
# nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP_FNN_wb --gen_func "gen_model_and_params_norm" > npfwoutfile5 &
...
# nohup python EXP_REAL_DATA.py --dataset ETTh --model NeuralProphetModel --params NP_FNN_sw_wb --gen_func "gen_model_and_params_norm" > npfswoutfile5 &
...
# nohup python EXP_REAL_DATA.py --dataset ETTh --model RNNModel --params RNN_wb_in --gen_func "gen_model_and_params_none" > rwoutfile5 &
...
# nohup python EXP_REAL_DATA.py --dataset ETTh --model RNNModel --params RNN_wb_ba --gen_func "gen_model_and_params_none" > rwoutfile5 &
